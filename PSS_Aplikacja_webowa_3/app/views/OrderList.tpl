...
<style>
    ...
    .order-table { width: 100%; border-collapse: collapse; background: white; box-shadow: 0 2px 8px rgba(0,0,0,0.1); border-radius: 8px; overflow: hidden; }
    ...
    <table class="order-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                {if $isPracownik|default:false}
                    {* Używamy modyfikatora default, aby uniknąć błędów gdyby klucz był pusty *}
                    <td><i class="fa fa-user"></i> {$o['login']|default:'---'}</td>
                {/if}
                ...
                <td style="max-width: 200px; font-size: 0.85em; color: #636e72;">
                    {$o['adres_dostawy']|default:'Brak danych'}
                </td>
                ...
                <td style="text-align: right;">
                    <div style="display: flex; gap: 10px; justify-content: flex-end;">
                        ...
                        {if $isPracownik|default:false && $o['status'] == 'nowe'}
            ...
            {foreachelse}
            <tr>
                {* Dynamiczna liczba kolumn dla pustego stanu *}
                <td colspan="{if $isPracownik|default:false}7{else}6{/if}" style="text-align: center; padding: 50px; color: #bdc3c7;">
                    <p style="font-size: 1.2em;">Brak zamówień do wyświetlenia.</p>
                </td>
            </tr>
            {/foreach}
        </tbody>
