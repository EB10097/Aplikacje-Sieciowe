...
tinymce.init({
    ...
    cmsms_tiny: cmsms_tiny = {
        schema: 'html5',
        base_url: 'https://localhost/cmsms/',
        resize: true,
        statusbar: true,
        menubar: true,
        filepicker_title: 'Wyb&oacute;r pliku',
        filepicker_url: 'https://localhost/cmsms/admin/moduleinterface.php?mact=FilePicker,m1_,filepicker,0&__c=e96cbdbbbb339aa52ab&showtemplate=false&field=',
        filebrowser_title: 'Select a file',
        linker_text: 'Link to CMSMS Page',
        linker_title: 'Create a link to a CMSMS content page',
        linker_image: 'https://localhost/cmsms/modules/MicroTiny/lib/images/cmsmslink.gif',
        linker_url: 'https://localhost/cmsms/admin/moduleinterface.php?mact=MicroTiny,m1_,linker,0&__c=e96cbdbbbb339aa52ab&showtemplate=false',
        linker_autocomplete_url: 'https://localhost/cmsms/admin/moduleinterface.php?mact=MicroTiny,m1_,ajax_getpages,0&__c=e96cbdbbbb339aa52ab&showtemplate=false',
        mailto_text: 'Create a mail link',
        mailto_title: 'Create a mail image',
        mailto_image: 'https://localhost/cmsms/modules/MicroTiny/lib/images/mailto.gif',
