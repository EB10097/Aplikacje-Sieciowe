...
{block name=content}
		...
		<div class="row">
			<div class="col span_24" style="text-align: center;">
				<a href="{$app_url}/ctrl.php" class="btn btn-icon btn-block" style="margin-top:5px; margin-bottom: 30px; display: inline-block; width: 200px;"><i class="icon icon-calculator"></i> Kalkulator</a>
			</div>
